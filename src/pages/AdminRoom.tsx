        ...
        <div className='flex w-[33vw] relative left-10 justify-between  gap-2'>
          ...
          <button
            ...
            className={`${isDarkMode ? 'ring-white text-white hover:ring-mainPurple-500' :
              'ring-mainPurple-500 text-mainPurple-500'} dark:ring-white dark:text-white dark:hover:ring-mainPurple-500 ring-1 rounded-lg  px-6  hover:text-white hover:bg-mainPurple-500 transition-colors`}>
            Encerrar sala
          </button>
        </div>
        <Modal
